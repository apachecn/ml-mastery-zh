...
+   [温和地介绍预测性建模](gentle-introduction-to-predictive-modeling.md)
...
+   [项目聚焦：使用 Mahout 和 Konstantin Slisenko 进行StackExchange群集](project-spotlight-stack-exchange-clustering-using-mahout-with-konstantin-slisenko.md)
