...
它由 Tomas Mikolov 等人开发。 2013 年谷歌作为回应使嵌入式神经网络培训更有效率，从那时起已成为开发预训练字嵌入的事实标准。
...
研究人员通常可以免费提供经过预先培训的单词嵌入，通常是在许可许可下，这样您就可以在自己的学术或商业项目中使用它们。
...
也许从快速方法开始，例如使用预先训练的嵌入，并且如果它能够在您的问题上获得更好的性能，则只使用新的嵌入。
