...
+   [如何使用Python从零开始创建算法测试工具](create-algorithm-test-harness-scratch-python.md)
...
+   [如何在Python中从零开始实现反向传播算法](implement-backpropagation-algorithm-scratch-python.md)
+   [如何用Python从零开始实现Bagging](implement-bagging-scratch-python.md)
+   [如何用Python从零开始实现基线机器学习算法](implement-baseline-machine-learning-algorithms-scratch-python.md)
+   [如何在Python中从零开始实现决策树算法](implement-decision-tree-algorithm-scratch-python.md)
+   [如何用Python从零开始实现学习向量量化](implement-learning-vector-quantization-scratch-python.md)
+   [如何利用Python从零开始随机梯度下降实现线性回归](implement-linear-regression-stochastic-gradient-descent-scratch-python.md)
+   [如何利用Python从零开始随机梯度下降实现逻辑回归](implement-logistic-regression-stochastic-gradient-descent-scratch-python.md)
+   [如何用Python从零开始实现机器学习算法表现指标](implement-machine-learning-algorithm-performance-metrics-scratch-python.md)
+   [如何在Python中从零开始实现感知机算法](implement-perceptron-algorithm-scratch-python.md)
...
+   [如何在Python中从零开始加载机器学习数据](load-machine-learning-data-scratch-python.md)
...
+   [如何在Python中从零开始实现朴素贝叶斯](naive-bayes-classifier-scratch-python.md)
...
+   [如何使用Python从零开始扩展机器学习数据](scale-machine-learning-data-scratch-python.md)
