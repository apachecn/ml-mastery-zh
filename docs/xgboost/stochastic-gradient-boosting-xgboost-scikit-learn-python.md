# 使用 XGBoost 进行随机梯度提升和 Python 中的 scikit-learn
...
在这篇文章中，您将发现随机梯度增强以及如何使用 XGBoost 和 Python 中的 scikit-learn 来调整采样参数。
...
我们将调整 Python 中 XGBoost 库支持的三种不同风格的随机梯度增强，具体来说：
