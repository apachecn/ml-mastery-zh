...
例如，您可以创建一个概率为 20％的dropout图层，并将其添加到您的模型中，如下所示：
...
您在本课程中的目标是为 CIFAR-10 数据集开发一个深度卷积神经网络。我建议重复模式的卷积和池图层。考虑尝试dropout和长训练时间。
...
*   您了解了更多高级技术，例如dropout正则化和学习速率时间表，以及如何在 Keras 中使用这些技术。
