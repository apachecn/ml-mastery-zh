...
服务器实例运行于Linux平台，虽然您可能不知道如何使用Linux或者类Unix系统，但我们只是运行我们的 Python 脚本，因此不需要高级技能，所以选用Linux平台是可取的行为。
...
*   4.单击“启动实例”按钮。
*   5.单击“社区 AMI”。 AMI 是亚马逊机器镜像，这是服务器的固定实例，您可以在新虚拟服务器上进行选择和实例化。
...
*   13.如果尚未执行此操作，请限制密钥对文件的访问权限,这也是通过SSH访问服务器的一部分，示例如下：
