...
+   [在 Keras 展示深度学习模式训练历史](display-deep-learning-model-training-history-in-keras.md)
+   [基于 Keras 的深度学习模型中的dropout规律化](dropout-regularization-deep-learning-models-keras.md)
