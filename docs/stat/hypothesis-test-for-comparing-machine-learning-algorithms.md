...
解决方法是使用**统计假设检验**来评估任意两种算法之间的平均表现差异是否真实。
...
[模型选择](https://machinelearningmastery.com/a-gentle-introduction-to-model-selection-for-machine-learning/)包括评估一套不同的机器学习算法或建模管道，并根据它们的表现进行比较。
...
我们将在这个数据集上比较两种线性算法的表现。具体来说，一个[逻辑回归](https://machinelearningmastery.com/logistic-regression-tutorial-for-machine-learning/)算法和一个[线性判别分析](https://machinelearningmastery.com/linear-discriminant-analysis-for-machine-learning/) (LDA)算法。
